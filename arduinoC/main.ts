...
namespace GestureTouchSensore {
    ...
    export function GestureTouchSensoreInitSSR(parameter: any, block: any) {
        ...
        Generator.addObject("GestureTouchSensoreInitObjectDFRobot_Gesture_Touc_rslt", "int8_t", `DFRobot_Gesture_Touc_rslt=0;`);
    ...
    //% board="esp32","arduino"
    //% block="GestureTouchSensore init [SR] pin SRX [SRX] STX [STX]" blockType="command"
    ...
    export function GestureTouchSensoreInitSR(parameter: any, block: any) {
        ...
        Generator.addObject("GestureTouchSensoreInitObjectDFRobot_Gesture_Touch_rslt", "int8_t", `DFRobot_Gesture_Touch_rslt=0;`);
        ...
        if(Generator.board=="arduino"){
            ...
            Generator.addSetup(`GestureTouchSensoreInitSetupmySerial${sr}`,`${sr}.begin(9600,${rx},${tx});`);
        }
        Generator.addSetup("GestureTouchSensoreInitSetupDFGT", "DFGT.setGestureDistance(20);");
    ...
    export function GestureTouchSensoreRead(parameter: any, block: any) {
        Generator.addCode("DFRobot_Gesture_Touch_rslt = DFGT.getAnEvent();");
    }
    ...
    export function GestureTouchSensoreRSLT(parameter: any, block: any) {
        ...
        Generator.addCode([`DFRobot_Gesture_Touch_rslt == ${rslt}`,Generator.ORDER_UNARY_POSTFIX]);
    }
